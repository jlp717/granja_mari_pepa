...
const distributors = [
  // ... (data structure remains the same for IDs and styles, text will be overridden)
  {
    id: 'grupo-topgel',
    name: 'Grupo Topgel',
    // Text fields will be replaced by translations in render
    image: '/images/logo-gtg.png',
    externalUrl: 'http://www.grupotopgel.es/',
    size: 'large' as const,
    color: '#3B82F6',
    // Keys for specialties translation
    specialtiesKeys: ['seafood', 'meats', 'precooked', 'pastry']
  },
  {
    id: 'nestle',
    name: 'Nestlé',
    ...
    size: 'large' as const,
    color: '#EF4444',
    specialtiesKeys: ['ice_cream_hospitality', 'tubs', 'frozen_desserts', 'specialties']
  },
  {
    id: 'panamar',
    name: 'Panamar',
    ...
    color: '#06B6D4',
    specialtiesKeys: ['frozen_bread', 'fermented_dough', 'pastry']
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-blue-300 font-bold text-xs sm:text-sm tracking-wider">{t('official_partners')}</span>
                ...
                >
                  ...
                  <div className="relative z-10 h-full flex flex-col p-6 sm:p-8">
                    ...
                    <div className="flex items-start justify-between mb-6">
                      ...
                      >
                        {tBrands(`${distributor.id}.category`)}
                      </span>
                    </div>
