...
import { Filter, Grid, List, Search, ChevronDown, Star, Zap, Clock, TrendingUp, Award, Sparkles, X, Lock } from 'lucide-react';
...
export default function ProductsPage() {
  ...
  const filteredProducts = useMemo(() => {
    let filtered = products.filter(product => {
      ...
      const matchesNew = !showNew || product.featured; // Usar featured como new por ahora
    ...
    return filtered;
  }, [products, searchTerm, selectedCategory, priceRange, showDiscounted, showInStock, showFeatured, showNew, sortBy]);
  ...
  // Mostrar pantalla de carga mientras se cargan productos (solo si ya está autenticado)
