...
// Nombres del negocio (comercial y fiscal) - usar primero NOMBREALTERNATIVO
...
const RESOLVED_FISCAL_NAME_EXPR = `TRIM(CLI.NOMBRECLIENTE)`;
...
function normalizePanamarLine(line) {
  ...
  // ✅ RESTAURADO: Lógica original de precio de cobro
  // Si existe tarifa Panamar (84/85), usarla. Si no, usar precio venta.
