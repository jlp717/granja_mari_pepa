  ...
  try {
    ...
    return new Promise((resolve, reject) => {
      ...
      lines.forEach((line, index) => {
        ...
        // Fondo alternado para mejor legibilidad - REMOVIDO para diseño limpio
        // if (alternateRow) {
        //   doc.rect(40, y, 515, 11)
        //      .fillAndStroke(COLORS.ultraLight + 'aa', COLORS.ultraLight + 'aa');
        // }

        // Borde de fila - REMOVIDO para diseño limpio
        // doc.rect(40, y, 515, 11).strokeColor(COLORS.border).lineWidth(0.5).stroke();
